...
namespace PaintIn3D
{
	...
	public class P3dPaintSphere : MonoBehaviour, IHit, IHitPoint, IHitLine
	{
		public class Command : P3dCommand
		{
			...
			public void SetMaterial(P3dBlendMode blendMode, float hardness, Color color, float opacity)
			{
		...
		public void HandleHitPoint(List<P3dCommand> commands, List<P3dTransform> repeaters, bool preview, Collider collider, Vector3 worldPosition, Quaternion worldRotation, float pressure)
		{
			...
			Command.Instance.SetMaterial(blendMode, finalHardness, finalColor, finalOpacity);

			Command.Instance.Preview = preview;
			Command.Instance.Groups  = groups;
		...
		public void HandleHitLine(List<P3dCommand> commands, List<P3dTransform> repeaters, bool preview, Vector3 worldPositionA, Vector3 worldPositionB, float pressureA, float pressureB)
		{
			...
			Command.Instance.SetMaterial(blendMode, finalHardnessA, color, finalOpacityA);
